...
function action(mode, type, selection) {
    if (mode < 1)  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("好吧，你好！欢迎来到嵩山镇整形外科！你想把你的脸换成新的吗？使用#b#i5152044##k,你可以选择你想更换的脸型~!\r\n#L2##b使用#b#i5152044##t5152044##l");
        } else if (status == 1) {
            if (selection == 2) {
                facenew = Array();
                ...
                cm.sendStyle("让我们看看。。。我完全可以把你的脸变成你想要的的。你不想试试吗？使用#b#t5152044##k, 你可以得到你喜欢的面孔。花点时间选择你喜欢的脸型.", facenew);
            }
        }
        else if (status == 2){
            cm.dispose();
            if (cm.haveItem(5152044) == true){
                cm.gainItem(5152044, -1);
