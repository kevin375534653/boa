...
function action(mode, type, selection) {
    if (mode <= 0) {
        cm.sendOk("嗯……这对你来说应该不是什么坏事。 在合适的时间来见我，您可能会得到更好的物品。 不管怎样，当你改变主意时请告诉我。");
        cm.dispose();
        return;
    }
    ...
    if (status == 0) { // first interaction with NPC
        cm.sendNext("嘿，有空吗？嗯，我的工作是在这里收集物品并在其他地方出售，但这些天怪物变得更加凶恶，所以很难买到好的物品。。。你觉得怎么样？你想和我做点生意吗？");
    } else if (status == 1) {
        cm.sendYesNo("交易很简单。你给我一些我需要的东西，我给你一些你需要的东西。问题是，我和一群人打交道，所以每次你看到我，我提供的东西可能都会改变。你觉得呢？还想做吗？");
    } else if (status == 2) {
        ...
        cm.sendYesNo("让我们看看，你想用我的东西交换你的#b100#t"+requiredItem+"##k，对吧？在交易之前，请确保您的使用等库存中有一个空插槽。现在，你想和我交易吗？");
    } else if (status == 4) {
        ...
        if (!cm.haveItem(requiredItem, 100)) {
            cm.sendOk("嗯…你确定你有#b100#t"+requiredItem+"##k吗？如果是，请检查您的物品库存是否已满。");
        } else if (!cm.canHold(prizeItem)) {
            cm.sendOk("您的背包似乎已经满了。你等你有空余的物品栏来和我交易吧！腾出空间，然后来找我。");
        } else {
            cm.gainItem(requiredItem, -100);
            cm.gainExp(500 * cm.getPlayer().getExpRate());
            cm.gainItem(prizeItem, prizeQuantity);
            cm.sendOk("对于您的#b100#t"+requiredItem+"##k，这是我的#b"+prizeQuantity+"#t"+prizeItem+"##k。你觉得怎么样？你喜欢我给你的回报吗？我计划在这里呆一段时间，所以如果你收集更多的物品，我总是愿意交易。。。");
        }
        cm.dispose();
    }
}
...
function makeChoices(a) {
    var result = "好啊首先，你需要选择交易的物品。物品越好，我就越有可能给你更好的回报。\r\n";
