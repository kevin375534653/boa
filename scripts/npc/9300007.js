...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) { //我想进去红鸾宫
            ...
            status = 9;
            cm.sendNext("你要去宴客堂吗？要去宴客堂必须有#v3991014#(1个)，才可以进去。");
        ...
        if (cm.haveItem(3991014)) {
            cm.gainItem(3991014, -1)
            cm.warp(700000200);
            cm.sendNext("看来你带来了#v3991014#(1个)，我已经将你送到宴客堂。")
            cm.dispose();
        } else {
            cm.sendNext("你好像没有#v3991014#(1个)吧。没有#v3991014#(1个)就进不去")
            cm.dispose();
        }
    } else if (status == 11) {
