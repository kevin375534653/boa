...
Array(2049100,20,1, 1), //必成
Array(2340000,20,1, 1), //
Array(2044303,20,1, 1), //
Array(2044003,20,1, 1), //
Array(2044203,20,1, 1), //
Array(2043303,20,1, 1), //
Array(2043803,20,1, 1), //
Array(2043703,20,1, 1), //
Array(2044503,20,1, 1), //
Array(2044603,20,1, 1), //
Array(2044703,20,1, 1), //
...
Array(2044705, 800, 1, 1), //拳套攻击诅咒卷轴
Array(2044704, 800, 1, 1), //拳套攻击诅咒卷轴
Array(2044605, 800, 1, 1), //弩攻击诅咒卷轴
Array(2044604, 800, 1, 1), //弩攻击诅咒卷轴
Array(2044505, 800, 1, 1), //弓攻击诅咒卷轴
Array(2044504, 800, 1, 1), //弓攻击诅咒卷轴
Array(2044405, 800, 1, 1), //矛攻击诅咒卷轴
Array(2044404, 800, 1, 1), //矛攻击诅咒卷轴
Array(2044305, 800, 1, 1), //枪攻击诅咒卷轴
Array(2044304, 800, 1, 1), //枪攻击诅咒卷轴
Array(2044205, 800, 1, 1), //双手钝器攻击诅咒卷轴
Array(2044204, 800, 1, 1), //双手钝器攻击诅咒卷轴
Array(2044105, 800, 1, 1), //双手斧攻击诅咒卷轴
Array(2044104, 800, 1, 1), //双手斧攻击诅咒卷轴
Array(2044005, 800, 1, 1), //双手剑攻击诅咒卷轴
Array(2044004, 800, 1, 1), //双手剑攻击诅咒卷轴
Array(2043305, 800, 1, 1), //短剑攻击诅咒卷轴
Array(2043304, 800, 1, 1), //短剑攻击诅咒卷轴
Array(2043205, 800, 1, 1), //单手钝器攻击诅咒卷轴
Array(2043204, 800, 1, 1), //单手钝器攻击诅咒卷轴
Array(2043105, 800, 1, 1), //单手斧攻击诅咒卷轴
Array(2043104, 800, 1, 1), //单手斧攻击诅咒卷轴
Array(2043005, 800, 1, 1), //单手剑攻击诅咒卷轴
Array(2043004, 800, 1, 1), //单手剑攻击诅咒卷轴
Array(2040917, 800, 1, 1), //盾牌攻击诅咒卷轴30%
Array(2040916, 800, 1, 1), //盾牌攻击诅咒卷轴70%
Array(2040811, 800, 1, 1), //手套攻击诅咒卷轴
Array(2040810, 800, 1, 1), //手套攻击诅咒卷轴
...
Array(1382049, 80, 1, 1), //朱雀长杖
Array(1382050, 80, 1, 1), //玄武长杖
Array(1382051, 80, 1, 1), //白虎长杖
Array(1382052, 80000, 1, 1), //青龙长杖
...
Array(2040807, 5, 1, 1), //手套攻击诅咒卷轴
Array(2040506, 5, 1, 1), //全身盔甲敏捷必成卷
Array(2040507, 5, 1, 1), //全身盔甲防御必成卷
Array(2040710, 5, 1, 1), //鞋子跳跃必成卷
Array(2040806, 5, 1, 1), //手套敏捷必成卷
Array(2040303, 5, 1, 1), //耳环智力必成卷
Array(2044103, 5, 1, 1), //双手斧攻击必成卷
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (cm.haveItem(4110010)) {
            cm.sendYesNo("豆豆机中有各类#b装备、卷轴或稀有新奇的道具#k噢！使用“#b#t4110010##k”就可以交换. 现在要玩转蛋机么? ");
        } else {
        ...
        if (finalitem.length != 0) {
            ...
            item = cm.gainGachaponItem(itemId, quantity, "豆豆机", notice);
            if (item != -1) {
                cm.gainItem(4110010, -1);
                cm.sendOk("你获得了#b#t" + item + "##k");
            } else {
                cm.sendOk("你确实有#b#v4110010##k吗？如果是，请你确认在背包的装备，消耗，其他窗口中是否有一格以上的空间。");
            }
            cm.dispose();
        } else {
