...
var mhair_r = Array(30030, 30040, 30000, 30062, 30110, 30120, 30160, 30260, 30270, 30420, 30550, 30340, 30300);
var fhair_r = Array(31000, 31420, 31290, 31490, 30420, 31480, 31810, 31080, 31880, 31030, 31850, 31700, 34000);
var mhair_e = Array(30030, 30040, 30000, 30062, 30110, 30120, 30160, 30260, 30270, 30420, 30550, 30340, 30300);
var fhair_e = Array(31000, 31420, 31290, 31490, 30420, 31480, 31810, 31080, 31880, 31030, 31850, 31700, 34000);
var hairnew = Array();
...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("嗨，我是#p9310017#。如果你有#b#t5150014##k或者#b#t5151010##k其中的任意一个，我可以为你随机更换发型或者发色。\r\n\r\n#L0##b使用#i5150014##t5150014##k\r\n#L2##b使用#i5151010##t5151010##l");
        } else if (status == 1) {
            if (selection == 0) {
                beauty = 3;
                hairnew = Array();
                ...
                cm.sendYesNo("如果你使用#b#t5150014##k，你的发型将随机改变，不过有机会获得一种新的发型，你确定要使用#b#t5150014##k更换你的发型吗?");
            } else if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                if (cm.getPlayer().getGender() == 0) {
                ...
                cm.sendYesNo("如果你使用#b#t5151010##k，你的发型将随机改变，不过有机会获得一种新的发型，你确定要使用#b#t5151010##k更换你的发型吗?");
            }
        }
        else if (status == 2){
            cm.dispose();
