...
function action(mode, type, selection) {
        if (mode == -1) {
                ...
                if (status == 0) {
                        var sendStr = "HeavenMS 的开发时间跨度为 4 年，以 Solaxia 离开的地方为基础。 我很高兴地说，开发本身一直受到数十名贡献者和欢呼者的鼓励（真正感谢大家的信任誓言！）。\r\n\r\n谈论结果：出现了许多不错的功能，开发 旨在找回旧的 GMS 体验。 现在，许多长期缺失的功能都以该服务器的形式优雅地呈现给您。 冒险岛万岁！！\r\n\r\n这些是 #bHeavenMS#k 的功能：\r\n\r\n";
                        for(var i = 0; i < tabs.length; i++) {
