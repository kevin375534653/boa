    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 0) { // How do I move?
				...
				cm.showIntro("UI/tutorial.img/20");
                ...
                cm.showIntro("UI/tutorial.img/21");
                ...
                cm.showIntro("UI/tutorial.img/28");
                ...
                cm.showIntro("UI/tutorial.img/29");
