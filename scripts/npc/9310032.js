...
function action(mode, type, selection) {
    if (mode < 1) {
        ...
        status++;
        if (status == 0) 
            cm.sendSimple("你好，我是嵩山镇老板娘丢夫人. 如果你有#b#t5150035##k或者#b#t5151030##k，我可以为你改变发型或者发色. 请选择吧！\r\n#L1##b使用#i5150035##t5150035##l\r\n#L2##b使用#i5151030##t5151030##l");
        else if (status == 1) {
            if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                ...
                cm.sendStyle("我完全可以改变你的发型，让它看起来很好看。你可以尝试改变一下。如果你有#b#t5150035##k我会改变你的发型. 挑选你喜欢的发型吧！", hairnew);
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendStyle("我完全可以改变你的发色，让它看起来很好看。你可以尝试改变一下。 使用#b#t5151030##k我会改变你的发色.挑选你喜欢的颜色吧！", haircolor);
            }
        } else if (status == 2){
            cm.dispose();
            if (beauty == 1){
