...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        var selStr = "孩子...如果您有合适的商品，我可以把它变成好东西...#b"
        var options = ["制作手套", "升级手套", "制作拳套", "升级拳套", "木材与螺丝钉制作"];
        ...
        if (selectedType == 0) { //glove refine
            ...
            var gloves = ["工地手套#k - 全职业 Lv. 10#b", "褐短指手套#k - 飞侠 Lv. 15#b", "蓝短指手套#k - 飞侠 Lv. 15#b", "黑短指手套#k - 飞侠 Lv. 15#b", "青铜飞侠手套#k - 飞侠 Lv. 20#b", "青铜精神手套#k - 飞侠 Lv. 25#b", "钢铁暴风手套#k - 飞侠 Lv. 30#b",
            ...
            var gloves = ["锂矿飞侠手套#k - 飞侠 Lv. 20#b", "黑色飞侠手套#k - 飞侠 Lv. 20#b", "锂矿精神手套#k - 飞侠 Lv. 25#b",
            ...
            var claws = ["钢铁拳套#k - 飞侠 Lv. 15#b", "青铜指虎#k - 飞侠 Lv. 20#b", "狼牙#k - 飞侠 Lv. 25#b", "钢铁斗拳#k - 飞侠 Lv. 30#b", "青铜守护指套#k - 飞侠 Lv. 35#b", "钢铁护腕#k - 飞侠 Lv. 40#b", "钢铁手甲#k - 飞侠 Lv. 50#b"];
        ...
        if (!complete) {
            ...
            cm.sendOk("全部做完。如果你还需要什么……好吧，我哪儿也不去。");
        }
        cm.dispose();
    }
}