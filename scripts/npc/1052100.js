    ...
    if (mode < 1)  // disposing issue with stylishs found thanks to Vcoc
    {
        ...
        if (status == 0) {
            ...
            if (selection == 1) {
                ...
                cm.sendStyle("我可以给你换新的发型。是不是对现在的发型感到厌倦了？如果你有#b#t5150003##k。我就给你换发型。慢慢选你喜欢的发型吧。", hairnew);
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendStyle("我可以给你改变发型颜色，让它看起来很好看。你为什么不尝试改变呢？使用#b#t5151003##k我会为你改变发色。", haircolor);
            }
        } else if (status == 2) {
            cm.dispose();
            if (beauty == 1) {
