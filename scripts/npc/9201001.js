...
function processNanaQuest() {
    if(cm.haveItem(questItems[nanaLoc], 50)) {
        ...
        cm.sendOk("请带来#b50 #t" + questItems[nanaLoc] + "##k，再来跟我谈谈吧。");
    }
        ...
        if(status == 0) {
            ...
            if(!cm.haveItem(4031367 + nanaLoc, 1)) {
                if(cm.isQuestCompleted(100401 + nanaLoc)) {
                    state = 1;
                    cm.sendAcceptDecline("我给了你#k#t4031367##k你是不是丢了？好吧，我可以再和你分享一个，但你需要重做我上次问你的那件事，可以吗？我需要你带我来 #r50 #t" + questItems[nanaLoc] + "##k");
                    ...
                    state = 0;
                    cm.sendAcceptDecline("你在找#k#t4031367##k？我可以和你分享一个，但你必须帮我一个忙，可以吗？");
                }
            } else {
