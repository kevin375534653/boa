...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("你好，我是嵩山镇美发店助理小叶子. 如果你有#b#t5150034##k或者#b#t5151029##k其中的任意一个,我可以为你随机更换发型或者发色。\r\n\r\n#L0##b使用#i5150034##t5150034##k\r\n#L2##b使用#i5151029##t5151029##l");
        } else if (status == 1) {
            if (selection == 0) {
                beauty = 3;
                hairnew = Array();
                ...
                cm.sendYesNo("如果你使用#b#t5150034##k，你的发型将随机改变，不过有机会获得一种新的发型，你确定要使用#b#t5150034##k更换你的发型吗?");
            } else if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                if (cm.getPlayer().getGender() == 0) {
                ...
                cm.sendYesNo("如果你使用#b#t5151029##k，你的发色将随机改变，不过有机会获得一种新的发型颜色，你确定要使用#b#t5151029##k更换你的发色吗?");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
