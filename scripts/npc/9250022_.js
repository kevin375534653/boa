...
//拥有属性时装脸饰每次可通过消耗三种等级祖母绿,黄晶增加HP,MP上限  下级+20,中级+30,上级+50  最多可强化300次
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#b#L0#1 . 制作全新血衣#l#k\r\n";
            text += "#b#L1#2 . 升级当前血衣#l#k\r\n";
            text += "#b#L2#3 . 血衣属性转移#l#k\r\n";
            ...
            if (selection == 0) {
                ...
                if (当前血衣 != null) {
                    if (当前血衣.getItemLevel() >= 126) {
                        ...
                        text += "#b剩余强化次数 : " + (301 - 当前血衣.getItemLevel()) + "\r\n请选择一种宝石进行强化:\r\n";
            ...
            if (sel1 == 0) {
                ...
                继承对象.setStr(15 + 当前血衣.getItemLevel() / 20);
                继承对象.setDex(15 + 当前血衣.getItemLevel() / 20);
                继承对象.setInt(15 + 当前血衣.getItemLevel() / 20);
                继承对象.setLuk(15 + 当前血衣.getItemLevel() / 20);
                继承对象.setSpeed(15 + 当前血衣.getItemLevel() / 20);
                继承对象.setJump(15 + 当前血衣.getItemLevel() / 20);
                继承对象.Watk(当前血衣.getItemLevel() / 30);
                继承对象.Matk(当前血衣.getItemLevel() / 10);
                继承对象.setExpiration(-1);
                Java.type("client.inventory.manipulator.InventoryManipulator").removeFromSlot(cm.getClient(), -1, -102, 1, false);
