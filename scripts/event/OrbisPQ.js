...
function playerEntry(eim, player) {
    ...
    var texttt = "嗨，我叫帮佣易克，女神的管家。别惊慌，你现在看不到我了。当女神变成一块石头的时候，我同时失去了自己的力量。但是，如果你收集了云片的力量，那么我就可以恢复我的身体，重新回到我原来的自我。请收集#b20个#k云片并带回给我。现在，你只会看到我是一盏闪烁的微光。";
