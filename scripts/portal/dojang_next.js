                    ...
                    if (Math.floor(pi.getPlayer().getMapId() / 10000) == 92503) {
                        ...
                        for (var i = 0; i < 5; i++) {
                            ...
                            while (pIter.hasNext()) {
                                ...
                                for (var j = i; j >= 0; j--) {
                                    chr.message("获得训练分数" + chr.addDojoPointsByMap(mapId - 100 * j) + "分。训练分数总共累计" + chr.getDojoPoints() + "分。");
                                }
                        ...
                        pi.getPlayer().message("获得训练分数" + pi.getPlayer().addDojoPointsByMap(pi.getMapId()) + "分。训练分数总共累计" + pi.getPlayer().getDojoPoints() + "分。");
                        pi.playPortalSound();
