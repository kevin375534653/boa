...
public class RatesCommand extends Command {
    ...
    public void execute(Client c, String[] params) {
        ...
        String showMsg_ = "#e角色信息#n" + "\r\n\r\n";
        showMsg_ += "经验倍率: #e#b" + player.getExpRate() + "x#k#n" + (player.hasNoviceExpRate() ? " - novice rate" : "") + "\r\n";
        showMsg_ += "金币倍率: #e#b" + player.getMesoRate() + "x#k#n" + "\r\n";
        showMsg_ += "掉落倍率: #e#b" + player.getDropRate() + "x#k#n" + "\r\n";
        showMsg_ += "BOSS掉落倍率: #e#b" + player.getBossDropRate() + "x#k#n" + "\r\n";
        if (YamlConfig.config.server.USE_QUEST_RATE) {
            showMsg_ += "任务倍率: #e#b" + c.getWorldServer().getQuestRate() + "x#k#n" + "\r\n";
        }
