...
public class CommandsExecutor {
    ...
    public void handle(Client client, String message) {
        if (client.tryacquireClient()) {
            ...
            client.getPlayer().dropMessage(5, "请稍后再试。。。当前正在处理最新的命令。");
        }
    }
    ...
    private void handleInternal(Client client, String message) {
        ...
        if (command == null) {
            client.getPlayer().yellowMessage("指令 '" + commandName + "' 不可用。有关可用命令的列表，请参见@帮助");
            return;
        }
        ...
        log.info("角色 {} 使用指令 {}", client.getPlayer().getName(), command.getClass().getSimpleName());
    }
    ...
    private void registerLv0Commands() {
        ...
        addCommand(new String[]{"帮助", "commands"}, HelpCommand.class);
        addCommand("掉落上限", DropLimitCommand.class);
        addCommand("时间", TimeCommand.class);
//        addCommand("credits", StaffCommand.class);
        addCommand("复活", BuyBackCommand.class);
        addCommand("在线时间", UptimeCommand.class);
        addCommand("百宝箱产出", GachaCommand.class);
        addCommand("ea", DisposeCommand.class);//解卡
//        addCommand("changel", ChangeLanguageCommand.class);
        addCommand("装备等级", EquipLvCommand.class);
        addCommand("倍率信息", ShowRatesCommand.class);
        addCommand("角色信息", RatesCommand.class);
        addCommand("在线", OnlineCommand.class);
        addCommand("gm", GmCommand.class);
        addCommand("报告BUG", ReportBugCommand.class);
...
//        addCommand("地图归属", MapOwnerClaimCommand.class);
        addCommand("bosshp", BossHpCommand.class);
        addCommand("怪物hp", MobHpCommand.class);
    ...
    private void registerLv1Commands() {
        ...
        addCommand("怪物掉落", 1, WhatDropsFromCommand.class);
        addCommand("物品掉落", 1, WhoDropsCommand.class);
        addCommand("buffme", 1, BuffMeCommand.class);
        addCommand("传送", 1, GotoCommand.class);
    ...
    private void registerLv2Commands() {
        levelCommandsCursor = new Pair<>(new ArrayList<String>(), new ArrayList<String>());
        addCommand("金蛋",2, JDCommand.class);
        addCommand("满消耗", 2, RechargeCommand.class);
        addCommand("地图信息", 2, WhereaMiCommand.class);
        addCommand("隐身", 2, HideCommand.class);
        addCommand("解除隐身", 2, UnHideCommand.class);
        addCommand("sp", 2, SpCommand.class);
        addCommand("ap", 2, ApCommand.class);
        addCommand("激活buff", 2, EmpowerMeCommand.class);
        addCommand("buffmap", 2, BuffMapCommand.class);
        addCommand("buff", 2, BuffCommand.class);
        addCommand("轰炸", 2, BombCommand.class);
        addCommand("踢", 2, DcCommand.class);
        addCommand("清除掉落", 2, ClearDropsCommand.class);
        addCommand("清理背包", 2, ClearSlotCommand.class);
        addCommand("清理玩家位置", 2, ClearSavedLocationsCommand.class);
        ...
        addCommand("开放等级", 2, OpenLevelCommand.class);
