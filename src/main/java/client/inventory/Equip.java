...
public class Equip extends Item {
    ...
    private void gainLevel(Client c) {
        ...
        String lvupStr = "'" + ItemInformationProvider.getInstance().getName(this.getItemId()) + "' 现在等级 " + itemLevel + "! ";
        String showStr = "#e'" + ItemInformationProvider.getInstance().getName(this.getItemId()) + "'#b 现在 #e等级 #r" + itemLevel + "#k#b!";
    ...
    public String showEquipFeatures(Client c) {
        ...
        String eqpInfo = reachedMaxLevel() ? " #e#r最大等级#k#n" : (" 经验: #e#b" + (int) itemExp + "#k#n / " + ExpTable.getEquipExpNeededForLevel(itemLevel));
