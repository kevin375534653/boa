...
public abstract class CharacterFactory {
    ...
    protected synchronized static int createNewCharacter(Client c, String name, int face, int hair, int skin, int gender, CharacterFactoryRecipe recipe) {
        ...
        Server.getInstance().broadcastGMMessage(c.getWorld(), PacketCreator.sendYellowTip("[新角色]: " + c.getAccountName() + " 创建了一个新角色 " + name));
        log.info("账号 {} 创建了一个角色 {}", c.getAccountName(), name);
