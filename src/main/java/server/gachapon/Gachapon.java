...
public class Gachapon {
    ...
    public enum GachaponType {
        ...
        HENESYS(NpcId.GACHAPON_HENESYS, 74, 25, 1, new Henesys()),
        ELLINIA(NpcId.GACHAPON_ELLINIA, 74, 25, 1, new Ellinia()),
        PERION(NpcId.GACHAPON_PERION, 74, 25, 1, new Perion()),
        KERNING_CITY(NpcId.GACHAPON_KERNING, 74, 25, 1, new KerningCity()),
        SLEEPYWOOD(NpcId.GACHAPON_SLEEPYWOOD, 74, 25, 1, new Sleepywood()),
        MUSHROOM_SHRINE(NpcId.GACHAPON_MUSHROOM_SHRINE, 74, 25, 1, new MushroomShrine()),
        SHOWA_SPA_MALE(NpcId.GACHAPON_SHOWA_MALE, 74, 25, 1, new ShowaSpaMale()),
        SHOWA_SPA_FEMALE(NpcId.GACHAPON_SHOWA_FEMALE, 74, 25, 1, new ShowaSpaFemale()),
        LUDIBRIUM(NpcId.GACHAPON_LUDIBRIUM, 74, 25, 1, new Ludibrium()),
        NEW_LEAF_CITY(NpcId.GACHAPON_NLC, 74, 25, 1, new NewLeafCity()),
        EL_NATH(NpcId.GACHAPON_EL_NATH, 74, 25, 1, new ElNath()),
        NAUTILUS_HARBOR(NpcId.GACHAPON_NAUTILUS, 74, 25, 1, new NautilusHarbor());
    ...
    public static void log(Character player, int itemId, String map) {
        ...
        log.info("{} 获得一个 {} ({}) 在 {} 百宝箱.", player.getName(), itemName, itemId, map);
    }
}
