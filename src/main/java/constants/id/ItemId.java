...
public class ItemId {
    ...
    public static final int NX_CARD_1000 = 4031533;
    public static final int NX_CARD_5000 = 4031532;

    public static boolean isNxCard(int itemId) {
        return itemId == NX_CARD_100 || itemId == NX_CARD_250 || itemId == NX_CARD_1000 || itemId == NX_CARD_5000;
    }
    ...
    //稀有飞镖
    public static final int 高科技电光镖 = 2070019;
    public static final int 火焰飞镖 = 2070023;
    public static final int 无限飞镖 = 2070024;
    public static final int 白金飞镖 = 2070026;
}
